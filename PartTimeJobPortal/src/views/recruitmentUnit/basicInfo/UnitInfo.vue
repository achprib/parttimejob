            ...
            <el-form ref="formInfo" v-loading="listLoading" :rules="rules" :model="formInfo">
                ...
                <div style="text-align: center; margin-bottom: 10px">
                    ...
                    <div style="margin: 10px">
                        ...
                        >
                            ...
                            <div slot="tip" class="el-upload__tip">只能上传jpg/png文222件，且不超过500kb</div>
                        </el-upload>
                ...
                <div class="form-item">
                    <el-form-item label="简介" prop="profile">
                        <el-input type="textarea" rows="10" v-model="formInfo.profile"
                                  :disabled="formInfo.status == 3 ? false : true"/>
                    </el-form-item>
                </div>
                <div class="form-item">
                    <el-form-item label="相关证明" prop="profile">
                        <el-upload
                            ...
                            <div slot="tip" class="el-upload__tip">
                                上传证明照片，注：照片信息清晰可见，照片内容真实有效，不做任何修改，大小不超过10M。企业需上传营业执照,校园组织等只需上传相关证明
                            </div>
                        </el-upload>
                    </el-form-item>
                </div>
...
export default {
    ...
    data: function () {
        return {
            ...
            fileList: [],//头像
            fileList2: [],//审核文件
            // imageUrl: ossUrl + "111/1611987793378.jpg",//单位头像
            imageUrl: "https://testpartpimejob.oss-cn-beijing.aliyuncs.com/111/1611987793378.jpg",//单位头像
    ...
    methods: {
        ...
        async submitUpload() {
            ...
            var result = await submitUpload(this.fileList, 'recruitUnit/' + this.recruitUnitId + '/', 'recruitUnitImage', {
                used: '1',
                recruitUnitId: this.recruitUnitId
            });
        ...
        queryUnitImag() {
            this.$axios.post("/aliyunOss/getOne", {used: 1, recruitUnitId: this.recruitUnitId}).then(res => {
                if (res.code == 200) {
                    this.imageUrl = ossUrl + res.data.filePath;
                } else {
                    this.imageUrl = ""
                }
            })
