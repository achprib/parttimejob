...
const routes = [
    ...
    },
    {
        ...
        component: () => import(/* webpackChunkName "resume-editor"*/ "@/views/jobSeeker/ResumeEditor.vue"),
    },
    {
        path: "/resume/add",
        name: "resume-add",
        ...
        component: () => import(/* webpackChunkName "resume-editor"*/ "@/views/jobSeeker/ResumeAdd.vue"),
    },
    {
