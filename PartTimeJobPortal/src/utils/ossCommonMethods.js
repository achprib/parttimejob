...
export const commonUpload = function (f, client, storeAs, suffix) {
	console.log('111111---------commonUploadfffffffffffffffffffffffffffffff', f)
	console.log('111111---------commonUpload', storeAs)
	return client.put(storeAs, f).then((res) => {
		console.log("return client.put(storeAs, f).then((res) => {return client.put(storeAs, f).then((res) => {return client.put(storeAs, f).then((res) => {")
		debugger
