...
public class ResumeController {
    ...
    @PostMapping("/getMyOne")
    public AjaxResult selectOneResumeMy(@RequestBody ResumeDTO resumeDTO) throws Exception{
        Page<Resume> resume = resumeService.selectOneResumeMy(resumeDTO);
        if (resume==null){
            return AjaxResult.error("查不到");
        }
        return AjaxResult.success(resume);
