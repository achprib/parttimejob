        ...
        <article class="main">
            <el-menu :default-active="activeMenu" class="main-menu-vertical-aside" active-text-color="#FFF" router
                ...
                <el-submenu index="1">
                    ...
                    <el-menu-item index="/basicData/permission" @click="savePath('/basicData/permission','角色管理')">角色管理
                    </el-menu-item>
                </el-submenu>
                <el-submenu index="2">
                    ...
                    <el-menu-item index="/basicData/jobSeeker" @click="savePath('/basicData/jobSeeker','求职者管理')">求职者管理
                    </el-menu-item>
                    <el-menu-item index="/basicData/hrList" @click="savePath('/basicData/hrList','招聘人员管理')">招聘人员管理
                    </el-menu-item>
                </el-submenu>
                <el-submenu index="3">
